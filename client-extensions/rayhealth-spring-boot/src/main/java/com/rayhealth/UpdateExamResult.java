...
public class UpdateExamResult {
	...
	public void updateObjectEntry(
		Document document, JSONObject jsonObject, String jwtToken) {
	...
	private static final Log _log = LogFactory.getLog(UpdateExamResult.class);

	private static final String _lxcDXPMainDomain = "localhost:8080";
	private static final String _lxcDXPServerProtocol = "http";
